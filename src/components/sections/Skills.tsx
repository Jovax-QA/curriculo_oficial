...
const skillGroups: { title: string; skills: Skill[] }[] = [
  {
    ...
    skills: [
      ...
      { name: "Java + JUnit/TestNG", level: 82 },
      { name: "C# + NUnit", level: 78 },
      { name: "Robot Framework", level: 72 },
      { name: "Appium (Mobile)", level: 80 },
      { name: "UiPath (RPA)", level: 68 },
    ],
  },
  {
    title: "Testes de API",
    skills: [
      ...
      { name: "RestAssured (Java)", level: 82 },
      { name: "RestSharp (C#)", level: 78 },
    ],
  },
  {
    title: "Liderança & Delivery",
    skills: [
      { name: "Delivery Lead", level: 92 },
      { name: "Gestão de Equipes", level: 90 },
      { name: "Planejamento & Estimativas", level: 88 },
      { name: "Facilitação Ágil", level: 90 },
  ...
  },
  {
    title: "IA & Automação",
    skills: [
      { name: "Agentes de IA", level: 86 },
      { name: "Prompt Engineering", level: 84 },
      { name: "MCP", level: 80 },
      { name: "Playwright", level: 90 },
      { name: "ADR / SDD", level: 76 },
      { name: "Harness Engineering", level: 70 },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Jira / Azure DevOps", level: 92 },
      { name: "Jenkins (CI/CD)", level: 78 },
      { name: "Scrum / Kanban", level: 94 },
      { name: "C4 Model / BPMN", level: 82 },
    ],
  },
];
